...
class SignInActivity : AppCompatActivity() {
    ...
    companion object{
        const val KEY1 = "com.example.firebaselecture.SignInActivity.mail"
        const val KEY2 = "com.example.firebaselecture.SignInActivity.name"
        const val KEY3 = "com.example.firebaselecture.SignInActivity.id"
    }
